...
- Tuning: `PREMBLY_FACE_COMPARISON_PATH` (endpoint path) and `PREMBLY_FACE_MATCH_MIN_CONFIDENCE` (minimum match confidence, default 60) control the automatic pass threshold.
