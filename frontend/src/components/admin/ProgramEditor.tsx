    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
      ...
      <div className={`flex flex-col gap-3 bg-gradient-to-r ${meta.accent} px-4 py-3 sm:flex-row sm:items-center sm:justify-between`}>
        <div className="min-w-0">
          <h4 className="text-sm font-black text-white">{meta.title}</h4>
          <p className="text-[11px] leading-4 text-white/80">{meta.blurb}</p>
        </div>
        <span className={`inline-flex shrink-0 items-center gap-1.5 self-start rounded-full px-2.5 py-1 text-[10px] font-black tracking-wider sm:self-auto ${meta.chip}`}>
          {type}
        </span>
      </div>
      ...
      <div className="p-4 sm:p-5">
        ...
        {/* Tenures */}
        <div className="mb-4">
          <div className="mb-2 text-[11px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-500">Available tenures</div>
        ...
        {/* Fees */}
        <div className="mb-1">
          <div className="mb-2 text-[11px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-500">Program fees</div>
        ...
        <div className="mt-4 space-y-2.5 border-t border-slate-100 pt-4 dark:border-slate-800">
          <div className="flex items-center justify-between gap-3">
            <div>
              <div className="text-xs font-bold text-velo-900 dark:text-white">Collateral</div>
