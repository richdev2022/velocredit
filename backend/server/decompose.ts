  ...
  if (has("loanProducts")) {
    add("loanProducts", await upsertEntities<LoanProduct>(db, snapshot.loanProducts as readonly LoanProduct[], {
      ...
      columns: [
        ...
        { snake: "program_type", get: (row) => (row as LoanProduct).programType ?? null },
        ...
        { snake: "service_fee_percent", get: (row) => (row as LoanProduct).serviceFeePercent ?? 0 },
        ...
        { snake: "collateral_enabled", get: (row) => (row as LoanProduct).collateralEnabled ?? true },
        { snake: "collateral_required", get: (row) => (row as LoanProduct).collateralRequired ?? false },
