...
const envSchema = z.object({
  ...
  PREMBLY_BVN_PATH: z.string().startsWith("/").default("/verification/bvn_validation"),
  PREMBLY_NIN_PATH: z.string().startsWith("/").default("/verification/vnin-basic"),
  ...
  KUDI_APP_NAME_CODE: z.string().optional(),
  KUDI_OTP_TEMPLATE_CODE: z.string().optional(),
